...
// Memoized Components
const MenuItem = memo(({ icon: Icon, label, onSubmenuClick }: any) => {
...
const MegaMenu = memo(({ onSubmenuClick, isClosing }: any) => (
  <div
      ...
      >
        ...
        >
          <div className="relative flex flex-col bg-white rounded-xl">
            ...
            <div
              className="relative flex items-start border-b border-gray-200"
              style={{ height: 40 }}
            >
